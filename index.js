...
function get20s(array) {
  ...
  for (let i = 0; i < array.length; i++){
    let arrayCheck = array[i].years.split(" - ");
    if((arrayCheck[0] >= 1900 && arrayCheck[0] <= 2000) && (arrayCheck[1] >= 1900 && arrayCheck[1] <= 2000)){
...
function addArtist(array) {
  array.push({ 
    ...
    bio: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque illum culpa dolor possimus nisi asperiores! Impedit, exercitationem earum repellendus natus expedita at deserunt voluptas vero consequatur. Vel perferendis praesentium dolorum!' 
  })
  return array;
}
...
function lotsOfArt(array) {
  ...
  /*FORBIDDEN SOLUTION (keeping it here for future reference tho)*/ 
  // const newArr = array.filter(bigPainter => bigPainter.paintings >= 100)
  // const returnArr = [];
  // for(let i = 0; i < newArr.length; i++){
    // returnArr.push(newArr[i].name);
  // }
  // return returnArr;
